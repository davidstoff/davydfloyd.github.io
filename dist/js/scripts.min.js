...
$(function(){function e(){$(".carousel-menu-item").each(function(){var e=$(this),a=e.find(".carousel-menu-content").outerHeight();e.find(".carousel-menu-image").css("min-height",a)})}$(".s-menu").waypoint(function(){$(".advantage .card").each(function(e){var a=$(this);setInterval(function(){a.removeClass("card-off").addClass("card-on")},150*e)})},{offset:"20%"}),$("#my-menu").mmenu({extensions:["theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo1.png" alt="DavidCompany">'},offCanvas:{position:"right"},pageScroll:!0});var a=$("#my-menu").data("mmenu");a.bind("open:start",function(){$(".hamburger").addClass("is-active")}),a.bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".carousel-menu").on("initialized.owl.carousel",function(){setTimeout(function(){e()},100)}),$(".carousel-menu").owlCarousel({loop:!0,nav:!0,smartSpeed:700,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>'],responsiveClass:!0,dots:!1,responsive:{0:{items:1},800:{items:2},1100:{items:3}}}),e(),$(".cards").owlCarousel({items:1,margin:10,responsiveClass:!0,smartSpeed:700,nav:!0,navText:['<i class="fa fa-chevron-circle-left"></i>','<i class="fa fa-chevron-circle-right"></i>']}),$("select").selectize(),$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$("form .callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(e).find(".success").addClass("active").css("display","flex").hide().fadeIn(),setTimeout(function(){$(e).find(".success").removeClass("active").fadeOut(),e.trigger("reset")},3e3)}),!1})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});